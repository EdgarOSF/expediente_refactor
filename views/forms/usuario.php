...
<script src="../plugins/select2/select2.full.min.js"></script>
    ...
    <h2> <i class="fa fa-fw fa-user"></i> Usuarios</h2>
              ...
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
                   <h4 class="modal-title"> <i class="fa fa-fw fa-user"></i> Usuarios</h4>
                <input type="hidden" id="unidad" name="unidad" value="<?php  echo $_SESSION['fk_unidad_adm']; ?>">
              </div>
                    ...
                    <div class="input-group">
                      <div class="input-group-addon"><label for="tipo_usuario">Rol:</label></div>
                       <select class="form-control" name="fk_tipo_usuario" id="fk_tipo_usuario" required>
                        ...
                        <?php
                            $tipos= $con->getDatos("select * from tipo_usuario WHERE id>1");
                  $i=0;
                   ...
                   <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon"><label for="tipo_usuario">Unidad:</label></div>
                        <input type="text"   placeholder="descripcion" class="form-control" value="<?php echo $_SESSION['nombre_unidad']; ?>" disabled >
            ...
            <div class="panel-body table-responsive">
              <table id="tabla-datos-usuarios" style="font-size: 15px" class="table table-bordered table-striped table-hover">
                ...
                $fk_unidad_adm= $_SESSION["fk_unidad_adm"];
                  $array= $con->getDatos("SELECT u.id,u.nombre,u.cedula,u.alias,u.password,u.fk_tipo_usuario,u.fk_unidad_adm,u.estatus,ua.nombre as unidad,tu.descripcion as tipo_usuario FROM usuarios as u LEFT JOIN unidades_adm as ua ON ua.id=u.fk_unidad_adm LEFT JOIN tipo_usuario AS tu ON tu.id=u.fk_tipo_usuario where fk_unidad_adm='".$fk_unidad_adm."' and tu.id>1");
                  $i=0;
...
$("#fk_unidad_adm").select2({theme:"bootstrap"});
      ...
      success:function(respuesta)
       {    $("#id").val(respuesta.id);
          ...
          $("#password").val("*******************");
            ...
            $("#fk_unidad_adm").val(respuesta.unidad);
       }
  });
}
</script>
